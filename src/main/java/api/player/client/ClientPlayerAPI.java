...
public final class ClientPlayerAPI {
    ...
    public static void register(String id, Class<?> baseClass, ClientPlayerBaseSorting baseSorting) {
        try {
            ...
            if (id != null) log("Client Player: failed to register id '" + id + "'");
            else log("Client Player: failed to register ClientPlayerBase");
    ...
    private static List<IClientPlayerAPI> getAllInstancesList() {
        ...
        if (player != null) result.add((IClientPlayerAPI) player);
        return result;
    }
    ...
    public static ClientPlayerBase getClientPlayerBase(IClientPlayerAPI clientPlayer, String baseId) {
        ClientPlayerAPI clientPlayerAPI = clientPlayer.getClientPlayerAPI();
        if (clientPlayerAPI != null) return clientPlayerAPI.getClientPlayerBase(baseId);
        return null;
    }
    ...
    public static Set<String> getClientPlayerBaseIds(IClientPlayerAPI clientPlayer) {
        ...
        if (clientPlayerAPI != null) result = clientPlayerAPI.getClientPlayerBaseIds();
    ...
    public static Object dynamic(IClientPlayerAPI clientPlayer, String key, Object[] parameters) {
        ClientPlayerAPI clientPlayerAPI = clientPlayer.getClientPlayerAPI();
        if (clientPlayerAPI != null) return clientPlayerAPI.dynamic(key, parameters);
        return null;
    }
    ...
    private ClientPlayerBase createClientPlayerBase(String id) {
        ...
        try {
            if (contructor.getParameterTypes().length == 1) base = (ClientPlayerBase) contructor.newInstance(this);
    ...
    private void updateClientPlayerBases() {
        ...
        isAddStatModded = beforeAddStatHooks != null || overrideAddStatHooks != null || afterAddStatHooks != null;
        ...
        isDisplayGUIEnchantmentModded = beforeDisplayGUIEnchantmentHooks != null
        ...
        isDropPlayerItemWithRandomChoiceModded = beforeDropPlayerItemWithRandomChoiceHooks != null
        ...
        isGetBedOrientationInDegreesModded = beforeGetBedOrientationInDegreesHooks != null
        ...
        isGetBrightnessForRenderModded = beforeGetBrightnessForRenderHooks != null
        ...
        isGetDistanceSqToEntityModded = beforeGetDistanceSqToEntityHooks != null
        ...
        isSetPositionAndRotationModded = beforeSetPositionAndRotationHooks != null
    ...
    private ClientPlayerBase[] create(List<String> types) {
        ...
        for (int i = 0; i < result.length; i++) result[i] = getClientPlayerBase(types.get(i));
        return result;
    }
    ...
    public static void addExhaustion(IClientPlayerAPI target, float paramFloat) {
        ...
        if (clientPlayerAPI != null && clientPlayerAPI.isAddExhaustionModded) clientPlayerAPI.addExhaustion(paramFloat);
    ...
    private static final List<String> beforeAddStatHookTypes = new LinkedList<String>();
    private static final List<String> overrideAddStatHookTypes = new LinkedList<String>();
    private static final List<String> afterAddStatHookTypes = new LinkedList<String>();
    ...
    public static void closeScreen(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isCloseScreenModded) clientPlayerAPI.closeScreen();
        else target.localCloseScreen();
    }

    private void closeScreen() {
        if (beforeCloseScreenHooks != null)
            for (int i = beforeCloseScreenHooks.length - 1; i >= 0; i--) beforeCloseScreenHooks[i].beforeCloseScreen();

        if (overrideCloseScreenHooks != null)
            overrideCloseScreenHooks[overrideCloseScreenHooks.length - 1].closeScreen();
        else player.localCloseScreen();

        if (afterCloseScreenHooks != null)
            for (int i = 0; i < afterCloseScreenHooks.length; i++) afterCloseScreenHooks[i].afterCloseScreen();
    }
    ...
    private static final List<String> beforeCloseScreenHookTypes = new LinkedList<String>();
    private static final List<String> overrideCloseScreenHookTypes = new LinkedList<String>();
    private static final List<String> afterCloseScreenHookTypes = new LinkedList<String>();
    ...
    private static final List<String> beforeDisplayGUIBrewingStandHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIBrewingStandHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIBrewingStandHookTypes = new LinkedList<String>();
    ...
    private static final List<String> beforeDisplayGUIEditSignHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIEditSignHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIEditSignHookTypes = new LinkedList<String>();
    ...
    public static void displayGUIEnchantment(IClientPlayerAPI target, int paramInt1, int paramInt2, int paramInt3,
        ...
        else target.localDisplayGUIEnchantment(paramInt1, paramInt2, paramInt3, paramString);
    }
    ...
    private static final List<String> beforeDisplayGUIEnchantmentHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIEnchantmentHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIEnchantmentHookTypes = new LinkedList<String>();
    ...
    public static net.minecraft.entity.item.EntityItem dropPlayerItemWithRandomChoice(IClientPlayerAPI target,
        ...
        else _result = target.localDropPlayerItemWithRandomChoice(paramItemStack, paramBoolean1, paramBoolean2);
        return _result;
    }
    ...
    private static final List<String> beforeDropPlayerItemWithRandomChoiceHookTypes = new LinkedList<String>();
    private static final List<String> overrideDropPlayerItemWithRandomChoiceHookTypes = new LinkedList<String>();
    private static final List<String> afterDropPlayerItemWithRandomChoiceHookTypes = new LinkedList<String>();
    ...
    public static void fall(IClientPlayerAPI target, float paramFloat) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isFallModded) clientPlayerAPI.fall(paramFloat);
    ...
    public static float getBedOrientationInDegrees(IClientPlayerAPI target) {
        ...
        else _result = target.localGetBedOrientationInDegrees();
        return _result;
    }
    ...
    private static final List<String> beforeGetBedOrientationInDegreesHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetBedOrientationInDegreesHookTypes = new LinkedList<String>();
    private static final List<String> afterGetBedOrientationInDegreesHookTypes = new LinkedList<String>();
    ...
    public static int getBrightnessForRender(IClientPlayerAPI target, float paramFloat) {
        ...
        else _result = target.localGetBrightnessForRender(paramFloat);
        return _result;
    }
    ...
    private static final List<String> beforeGetBrightnessForRenderHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetBrightnessForRenderHookTypes = new LinkedList<String>();
    private static final List<String> afterGetBrightnessForRenderHookTypes = new LinkedList<String>();
    ...
    public static double getDistanceSqToEntity(IClientPlayerAPI target, net.minecraft.entity.Entity paramEntity) {
        ...
        else _result = target.localGetDistanceSqToEntity(paramEntity);
        return _result;
    }
    ...
    private static final List<String> beforeGetDistanceSqToEntityHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetDistanceSqToEntityHookTypes = new LinkedList<String>();
    private static final List<String> afterGetDistanceSqToEntityHookTypes = new LinkedList<String>();
    ...
    public static float getFOVMultiplier(IClientPlayerAPI target) {
        ...
        else _result = target.localGetFOVMultiplier();
        return _result;
    }
    ...
    private static final List<String> beforeGetFOVMultiplierHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetFOVMultiplierHookTypes = new LinkedList<String>();
    private static final List<String> afterGetFOVMultiplierHookTypes = new LinkedList<String>();
    ...
    private java.lang.String getHurtSound() {
        ...
        if (afterGetHurtSoundHooks != null)
            for (int i = 0; i < afterGetHurtSoundHooks.length; i++) afterGetHurtSoundHooks[i].afterGetHurtSound();
    ...
    private static final List<String> beforeGetHurtSoundHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetHurtSoundHookTypes = new LinkedList<String>();
    private static final List<String> afterGetHurtSoundHookTypes = new LinkedList<String>();
    ...
    public static net.minecraft.util.IIcon getItemIcon(IClientPlayerAPI target,
        ...
        else _result = target.localGetItemIcon(paramItemStack, paramInt);
        return _result;
    }
    ...
    private static final List<String> beforeGetItemIconHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetItemIconHookTypes = new LinkedList<String>();
    private static final List<String> afterGetItemIconHookTypes = new LinkedList<String>();
    ...
    public static int getSleepTimer(IClientPlayerAPI target) {
        int _result;
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isGetSleepTimerModded) _result = clientPlayerAPI.getSleepTimer();
        else _result = target.localGetSleepTimer();
        return _result;
    }
    ...
    private int getSleepTimer() {
        ...
        else _result = player.localGetSleepTimer();

        if (afterGetSleepTimerHooks != null)
            for (int i = 0; i < afterGetSleepTimerHooks.length; i++) afterGetSleepTimerHooks[i].afterGetSleepTimer();
    ...
    private static final List<String> beforeGetSleepTimerHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetSleepTimerHookTypes = new LinkedList<String>();
    private static final List<String> afterGetSleepTimerHookTypes = new LinkedList<String>();
    ...
    public static boolean handleLavaMovement(IClientPlayerAPI target) {
        ...
        else _result = target.localHandleLavaMovement();
        return _result;
    }
    ...
    private static final List<String> beforeHandleLavaMovementHookTypes = new LinkedList<String>();
    private static final List<String> overrideHandleLavaMovementHookTypes = new LinkedList<String>();
    private static final List<String> afterHandleLavaMovementHookTypes = new LinkedList<String>();
    ...
    public static boolean handleWaterMovement(IClientPlayerAPI target) {
        ...
        else _result = target.localHandleWaterMovement();
        return _result;
    }
    ...
    private static final List<String> beforeHandleWaterMovementHookTypes = new LinkedList<String>();
    private static final List<String> overrideHandleWaterMovementHookTypes = new LinkedList<String>();
    private static final List<String> afterHandleWaterMovementHookTypes = new LinkedList<String>();
    ...
    public static void heal(IClientPlayerAPI target, float paramFloat) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isHealModded) clientPlayerAPI.heal(paramFloat);
    ...
    public static boolean isInWater(IClientPlayerAPI target) {
        boolean _result;
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isIsInWaterModded) _result = clientPlayerAPI.isInWater();
    ...
    public static boolean isOnLadder(IClientPlayerAPI target) {
        boolean _result;
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isIsOnLadderModded) _result = clientPlayerAPI.isOnLadder();
    ...
    public static boolean isSneaking(IClientPlayerAPI target) {
        boolean _result;
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isIsSneakingModded) _result = clientPlayerAPI.isSneaking();
    ...
    public static boolean isSprinting(IClientPlayerAPI target) {
        boolean _result;
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isIsSprintingModded) _result = clientPlayerAPI.isSprinting();
        else _result = target.localIsSprinting();
        return _result;
    }

    private boolean isSprinting() {
        if (beforeIsSprintingHooks != null)
            for (int i = beforeIsSprintingHooks.length - 1; i >= 0; i--) beforeIsSprintingHooks[i].beforeIsSprinting();

        boolean _result;
        if (overrideIsSprintingHooks != null)
            _result = overrideIsSprintingHooks[overrideIsSprintingHooks.length - 1].isSprinting();
        else _result = player.localIsSprinting();

        if (afterIsSprintingHooks != null)
            for (int i = 0; i < afterIsSprintingHooks.length; i++) afterIsSprintingHooks[i].afterIsSprinting();
    ...
    private static final List<String> beforeIsSprintingHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsSprintingHookTypes = new LinkedList<String>();
    private static final List<String> afterIsSprintingHookTypes = new LinkedList<String>();
    ...
    public static void jump(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isJumpModded) clientPlayerAPI.jump();
    ...
    public static void onLivingUpdate(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isOnLivingUpdateModded) clientPlayerAPI.onLivingUpdate();
    ...
    public static void onUpdate(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isOnUpdateModded) clientPlayerAPI.onUpdate();
    ...
    private static final List<String> beforePlayStepSoundHookTypes = new LinkedList<String>();
    private static final List<String> overridePlayStepSoundHookTypes = new LinkedList<String>();
    private static final List<String> afterPlayStepSoundHookTypes = new LinkedList<String>();
    ...
    public static boolean pushOutOfBlocks(IClientPlayerAPI target, double paramDouble1, double paramDouble2,
        ...
        else _result = target.localPushOutOfBlocks(paramDouble1, paramDouble2, paramDouble3);
        return _result;
    }
    ...
    private static final List<String> beforePushOutOfBlocksHookTypes = new LinkedList<String>();
    private static final List<String> overridePushOutOfBlocksHookTypes = new LinkedList<String>();
    private static final List<String> afterPushOutOfBlocksHookTypes = new LinkedList<String>();
    ...
    public static net.minecraft.util.MovingObjectPosition rayTrace(IClientPlayerAPI target, double paramDouble,
        ...
        else _result = target.localRayTrace(paramDouble, paramFloat);
        return _result;
    }
    ...
    private static final List<String> beforeRayTraceHookTypes = new LinkedList<String>();
    private static final List<String> overrideRayTraceHookTypes = new LinkedList<String>();
    private static final List<String> afterRayTraceHookTypes = new LinkedList<String>();
    ...
    public static void respawnPlayer(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isRespawnPlayerModded) clientPlayerAPI.respawnPlayer();
        else target.localRespawnPlayer();
    }
    ...
    private void respawnPlayer() {
        ...
        else player.localRespawnPlayer();

        if (afterRespawnPlayerHooks != null)
            for (int i = 0; i < afterRespawnPlayerHooks.length; i++) afterRespawnPlayerHooks[i].afterRespawnPlayer();
    }
    ...
    private static final List<String> beforeRespawnPlayerHookTypes = new LinkedList<String>();
    private static final List<String> overrideRespawnPlayerHookTypes = new LinkedList<String>();
    private static final List<String> afterRespawnPlayerHookTypes = new LinkedList<String>();
    ...
    public static void setDead(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isSetDeadModded) clientPlayerAPI.setDead();
    ...
    public static void setPlayerSPHealth(IClientPlayerAPI target, float paramFloat) {
        ...
        else target.localSetPlayerSPHealth(paramFloat);
    }
    ...
    private static final List<String> beforeSetPlayerSPHealthHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetPlayerSPHealthHookTypes = new LinkedList<String>();
    private static final List<String> afterSetPlayerSPHealthHookTypes = new LinkedList<String>();
    ...
    private static final List<String> beforeSetPositionAndRotationHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetPositionAndRotationHookTypes = new LinkedList<String>();
    private static final List<String> afterSetPositionAndRotationHookTypes = new LinkedList<String>();
    ...
    public static void setSneaking(IClientPlayerAPI target, boolean paramBoolean) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isSetSneakingModded) clientPlayerAPI.setSneaking(paramBoolean);
    ...
    public static void setSprinting(IClientPlayerAPI target, boolean paramBoolean) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isSetSprintingModded) clientPlayerAPI.setSprinting(paramBoolean);
    ...
    public static net.minecraft.entity.player.EntityPlayer.EnumStatus sleepInBedAt(IClientPlayerAPI target,
        ...
        else _result = target.localSleepInBedAt(paramInt1, paramInt2, paramInt3);
        return _result;
    }
    ...
    private static final List<String> beforeSleepInBedAtHookTypes = new LinkedList<String>();
    private static final List<String> overrideSleepInBedAtHookTypes = new LinkedList<String>();
    private static final List<String> afterSleepInBedAtHookTypes = new LinkedList<String>();
    ...
    public static void swingItem(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isSwingItemModded) clientPlayerAPI.swingItem();
    ...
    public static void updateRidden(IClientPlayerAPI target) {
        ClientPlayerAPI clientPlayerAPI = target.getClientPlayerAPI();
        if (clientPlayerAPI != null && clientPlayerAPI.isUpdateRiddenModded) clientPlayerAPI.updateRidden();
