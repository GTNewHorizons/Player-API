...
public final class ServerPlayerAPI {
    ...
    public static void register(String id, Class<?> baseClass, ServerPlayerBaseSorting baseSorting) {
        try {
            ...
            if (id != null) log("Server Player: failed to register id '" + id + "'");
            else log("Server Player: failed to register ServerPlayerBase");
    ...
    private static void register(Class<?> baseClass, String id, ServerPlayerBaseSorting baseSorting) {
        if (!isCreated) {
            try {
                ...
                if (mandatory.getReturnType() != ServerPlayerBase.class) throw new NoSuchMethodException(
                        ServerPlayerBase.class.getName() + " "
                ...
                String[] errorMessageParts = new String[] { "========================================",
                        "The API \"Server Player\" version " + PlayerAPIPlugin.Version
        ...
        if (id == null) throw new NullPointerException("Argument 'id' can not be null");
        ...
        if (baseSorting != null) {
            ...
            addSorting(
                    id,
                    allBaseBeforeAddExperienceLevelSuperiors,
                    baseSorting.getBeforeAddExperienceLevelSuperiors());
            addSorting(
                    id,
                    allBaseBeforeAddExperienceLevelInferiors,
                    baseSorting.getBeforeAddExperienceLevelInferiors());
            addSorting(
                    id,
                    allBaseOverrideAddExperienceLevelSuperiors,
                    baseSorting.getOverrideAddExperienceLevelSuperiors());
            addSorting(
                    id,
                    allBaseOverrideAddExperienceLevelInferiors,
                    baseSorting.getOverrideAddExperienceLevelInferiors());
            ...
            addSorting(
                    id,
                    allBaseBeforeSetEntityActionStateSuperiors,
                    baseSorting.getBeforeSetEntityActionStateSuperiors());
            addSorting(
                    id,
                    allBaseBeforeSetEntityActionStateInferiors,
                    baseSorting.getBeforeSetEntityActionStateInferiors());
            addSorting(
                    id,
                    allBaseOverrideSetEntityActionStateSuperiors,
                    baseSorting.getOverrideSetEntityActionStateSuperiors());
            addSorting(
                    id,
                    allBaseOverrideSetEntityActionStateInferiors,
                    baseSorting.getOverrideSetEntityActionStateInferiors());
            addSorting(
                    id,
                    allBaseAfterSetEntityActionStateSuperiors,
                    baseSorting.getAfterSetEntityActionStateSuperiors());
            addSorting(
                    id,
                    allBaseAfterSetEntityActionStateInferiors,
                    baseSorting.getAfterSetEntityActionStateInferiors());
            ...
            addSorting(
                    id,
                    allBaseBeforeUpdatePotionEffectsSuperiors,
                    baseSorting.getBeforeUpdatePotionEffectsSuperiors());
            addSorting(
                    id,
                    allBaseBeforeUpdatePotionEffectsInferiors,
                    baseSorting.getBeforeUpdatePotionEffectsInferiors());
            addSorting(
                    id,
                    allBaseOverrideUpdatePotionEffectsSuperiors,
                    baseSorting.getOverrideUpdatePotionEffectsSuperiors());
            addSorting(
                    id,
                    allBaseOverrideUpdatePotionEffectsInferiors,
                    baseSorting.getOverrideUpdatePotionEffectsInferiors());
            addSorting(
                    id,
                    allBaseAfterUpdatePotionEffectsSuperiors,
                    baseSorting.getAfterUpdatePotionEffectsSuperiors());
            addSorting(
                    id,
                    allBaseAfterUpdatePotionEffectsInferiors,
                    baseSorting.getAfterUpdatePotionEffectsInferiors());
        ...
        addMethod(
                id,
                baseClass,
                beforeSetEntityActionStateHookTypes,
                "beforeSetEntityActionState",
                float.class,
                float.class,
                boolean.class,
                boolean.class);
        addMethod(
                id,
                baseClass,
                overrideSetEntityActionStateHookTypes,
    ...
    public static boolean unregister(String id) {
        ...
        for (IServerPlayerAPI instance : getAllInstancesList()) instance.getServerPlayerAPI().updateServerPlayerBases();

        Iterator<String> iterator = keysToVirtualIds.keySet().iterator();
        while (iterator.hasNext()) {
            String key = iterator.next();
            if (keysToVirtualIds.get(key).equals(id)) keysToVirtualIds.remove(key);
        }
    ...
    public static void removeDynamicHookTypes(String id, Map<String, List<String>> map) {
        ...
        while (keys.hasNext()) map.get(keys.next()).remove(id);
    }
    ...
    private static void addDynamicMethods(String id, Class<?> baseClass) {
        if (!dynamicTypes.add(baseClass)) return;
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            if (method.getDeclaringClass() != baseClass) continue;
            ...
            if (name.length() < 7 || !name.substring(0, 7).equalsIgnoreCase("dynamic")) continue;
            else name = name.substring(7);

            while (name.charAt(0) == '_') name = name.substring(1);
            ...
            if (name.length() == 0) throw new RuntimeException("Can not process dynamic hook method with no key");
            ...
            } else if (before) befores = addDynamicMethod(name, method, befores);
            else if (after) afters = addDynamicMethod(name, method, afters);
            else overrides = addDynamicMethod(name, method, overrides);
        }

        if (virtuals != null) virtualDynamicHookMethods.put(baseClass, virtuals);
        if (befores != null) beforeDynamicHookMethods.put(baseClass, befores);
        if (overrides != null) overrideDynamicHookMethods.put(baseClass, overrides);
    ...
    private static void addDynamicKeys(String id, Class<?> baseClass,
        ...
        while (keys.hasNext()) {
            ...
            if (!dynamicHookTypes.containsKey(key)) dynamicHookTypes.put(key, new ArrayList<String>(1));
    ...
    private static Map<String, Method> addDynamicMethod(String key, Method method, Map<String, Method> methods) {
        ...
        if (methods.containsKey(key)) throw new RuntimeException("method with key '" + key + "' allready exists");
        methods.put(key, method);
        return methods;
    }

    public static ServerPlayerAPI create(IServerPlayerAPI serverPlayer) {
        if (allBaseConstructors.size() > 0 && !initialized) initialize();
    ...
    private static void initialize() {
        ...
        sortBases(
                ...
                allBaseBeforeAddExperienceSuperiors,
                allBaseBeforeAddExperienceInferiors,
                "beforeAddExperience");
        sortBases(
                overrideAddExperienceHookTypes,
                allBaseOverrideAddExperienceSuperiors,
                allBaseOverrideAddExperienceInferiors,
                "overrideAddExperience");
        sortBases(
                afterAddExperienceHookTypes,
                allBaseAfterAddExperienceSuperiors,
                allBaseAfterAddExperienceInferiors,
                "afterAddExperience");
        ...
        sortBases(
                ...
                allBaseBeforeAddExperienceLevelSuperiors,
                allBaseBeforeAddExperienceLevelInferiors,
                "beforeAddExperienceLevel");
        sortBases(
                overrideAddExperienceLevelHookTypes,
                allBaseOverrideAddExperienceLevelSuperiors,
                allBaseOverrideAddExperienceLevelInferiors,
                "overrideAddExperienceLevel");
        sortBases(
                afterAddExperienceLevelHookTypes,
                allBaseAfterAddExperienceLevelSuperiors,
                allBaseAfterAddExperienceLevelInferiors,
                "afterAddExperienceLevel");
        ...
        sortBases(
                beforeClonePlayerHookTypes,
                allBaseBeforeClonePlayerSuperiors,
                allBaseBeforeClonePlayerInferiors,
                "beforeClonePlayer");
        sortBases(
                overrideClonePlayerHookTypes,
                allBaseOverrideClonePlayerSuperiors,
                allBaseOverrideClonePlayerInferiors,
                "overrideClonePlayer");
        sortBases(
                afterClonePlayerHookTypes,
                allBaseAfterClonePlayerSuperiors,
                allBaseAfterClonePlayerInferiors,
                "afterClonePlayer");
        ...
        sortBases(
                beforeGetEyeHeightHookTypes,
                allBaseBeforeGetEyeHeightSuperiors,
                allBaseBeforeGetEyeHeightInferiors,
                "beforeGetEyeHeight");
        sortBases(
                overrideGetEyeHeightHookTypes,
                allBaseOverrideGetEyeHeightSuperiors,
                allBaseOverrideGetEyeHeightInferiors,
                "overrideGetEyeHeight");
        sortBases(
                afterGetEyeHeightHookTypes,
                allBaseAfterGetEyeHeightSuperiors,
                allBaseAfterGetEyeHeightInferiors,
                "afterGetEyeHeight");
        ...
        sortBases(
                beforeMountEntityHookTypes,
                allBaseBeforeMountEntitySuperiors,
                allBaseBeforeMountEntityInferiors,
                "beforeMountEntity");
        sortBases(
                overrideMountEntityHookTypes,
                allBaseOverrideMountEntitySuperiors,
                allBaseOverrideMountEntityInferiors,
                "overrideMountEntity");
        sortBases(
                afterMountEntityHookTypes,
                allBaseAfterMountEntitySuperiors,
                allBaseAfterMountEntityInferiors,
                "afterMountEntity");
        ...
        sortBases(
                beforeOnUpdateEntityHookTypes,
                allBaseBeforeOnUpdateEntitySuperiors,
                allBaseBeforeOnUpdateEntityInferiors,
                "beforeOnUpdateEntity");
        sortBases(
                overrideOnUpdateEntityHookTypes,
                allBaseOverrideOnUpdateEntitySuperiors,
                allBaseOverrideOnUpdateEntityInferiors,
                "overrideOnUpdateEntity");
        sortBases(
                afterOnUpdateEntityHookTypes,
                allBaseAfterOnUpdateEntitySuperiors,
                allBaseAfterOnUpdateEntityInferiors,
                "afterOnUpdateEntity");
        ...
        sortBases(
                beforeSetPositionHookTypes,
                allBaseBeforeSetPositionSuperiors,
                allBaseBeforeSetPositionInferiors,
                "beforeSetPosition");
        sortBases(
                overrideSetPositionHookTypes,
                allBaseOverrideSetPositionSuperiors,
                allBaseOverrideSetPositionInferiors,
                "overrideSetPosition");
        sortBases(
                afterSetPositionHookTypes,
                allBaseAfterSetPositionSuperiors,
                allBaseAfterSetPositionInferiors,
                "afterSetPosition");
        ...
        sortBases(
                beforeUpdatePotionEffectsHookTypes,
                allBaseBeforeUpdatePotionEffectsSuperiors,
                allBaseBeforeUpdatePotionEffectsInferiors,
                "beforeUpdatePotionEffects");
        sortBases(
                overrideUpdatePotionEffectsHookTypes,
                allBaseOverrideUpdatePotionEffectsSuperiors,
                allBaseOverrideUpdatePotionEffectsInferiors,
                "overrideUpdatePotionEffects");
        sortBases(
                afterUpdatePotionEffectsHookTypes,
                allBaseAfterUpdatePotionEffectsSuperiors,
                allBaseAfterUpdatePotionEffectsInferiors,
                "afterUpdatePotionEffects");
    ...
    private static List<IServerPlayerAPI> getAllInstancesList() {
        ...
        try {
            Object minecraftServer = MinecraftServer.class.getMethod("func_71276_C").invoke(null);
            Object serverConfigurationManager = minecraftServer != null
                    ? MinecraftServer.class.getMethod("func_71203_ab").invoke(minecraftServer)
                    : null;
            entityPlayerList = serverConfigurationManager != null
                    ? serverConfigurationManager.getClass().getField("field_72404_b").get(serverConfigurationManager)
                    : null;
        } catch (Exception obfuscatedException) {
            try {
                Object minecraftServer = MinecraftServer.class.getMethod("getServer").invoke(null);
                Object serverConfigurationManager = minecraftServer != null
                        ? MinecraftServer.class.getMethod("getConfigurationManager").invoke(minecraftServer)
                        : null;
                entityPlayerList = serverConfigurationManager != null ? serverConfigurationManager.getClass()
                        .getField("playerEntityList").get(serverConfigurationManager) : null;
        ...
        if (entityPlayerList != null)
            for (Object entityPlayer : (List<?>) entityPlayerList) result.add((IServerPlayerAPI) entityPlayer);
        return result;
    }

    public static EntityPlayerMP[] getAllInstances() {
        List<IServerPlayerAPI> allInstances = getAllInstancesList();
        return allInstances.toArray(new EntityPlayerMP[allInstances.size()]);
    }

    public static void beforeLocalConstructing(IServerPlayerAPI serverPlayer, MinecraftServer paramMinecraftServer,
            WorldServer paramWorldServer, GameProfile paramGameProfile, ItemInWorldManager paramItemInWorldManager) {
        ServerPlayerAPI serverPlayerAPI = serverPlayer.getServerPlayerAPI();
        if (serverPlayerAPI != null) serverPlayerAPI.load();

        if (serverPlayerAPI != null) serverPlayerAPI.beforeLocalConstructing(
                paramMinecraftServer,
                paramWorldServer,
                paramGameProfile,
                paramItemInWorldManager);
    }

    public static void afterLocalConstructing(IServerPlayerAPI serverPlayer, MinecraftServer paramMinecraftServer,
            WorldServer paramWorldServer, GameProfile paramGameProfile, ItemInWorldManager paramItemInWorldManager) {
        ServerPlayerAPI serverPlayerAPI = serverPlayer.getServerPlayerAPI();
        if (serverPlayerAPI != null) serverPlayerAPI.afterLocalConstructing(
                paramMinecraftServer,
                paramWorldServer,
                paramGameProfile,
                paramItemInWorldManager);
    ...
    public static ServerPlayerBase getServerPlayerBase(IServerPlayerAPI serverPlayer, String baseId) {
        ServerPlayerAPI serverPlayerAPI = serverPlayer.getServerPlayerAPI();
        if (serverPlayerAPI != null) return serverPlayerAPI.getServerPlayerBase(baseId);
        return null;
    }
    ...
    public static Set<String> getServerPlayerBaseIds(IServerPlayerAPI serverPlayer) {
        ...
        if (serverPlayerAPI != null) result = serverPlayerAPI.getServerPlayerBaseIds();
        else result = Collections.<String>emptySet();
        return result;
    }

    public static Object dynamic(IServerPlayerAPI serverPlayer, String key, Object[] parameters) {
        ServerPlayerAPI serverPlayerAPI = serverPlayer.getServerPlayerAPI();
        if (serverPlayerAPI != null) return serverPlayerAPI.dynamic(key, parameters);
        return null;
    }
    ...
    private void load() {
        ...
        while (iterator.hasNext()) allBaseObjects.get(iterator.next()).afterBaseAttach(false);
    }
    ...
    private ServerPlayerBase createServerPlayerBase(String id) {
        ...
        try {
            if (contructor.getParameterTypes().length == 1) base = (ServerPlayerBase) contructor.newInstance(this);
            else base = (ServerPlayerBase) contructor.newInstance(this, id);
        } catch (Exception e) {
            throw new RuntimeException(
                    "Exception while creating a ServerPlayerBase of type '" + contructor.getDeclaringClass() + "'",
                    e);
        }
        return base;
    }
    ...
    private void updateServerPlayerBases() {
        ...
        isAddExperienceModded = beforeAddExperienceHooks != null || overrideAddExperienceHooks != null
        ...
        isAddExperienceLevelModded = beforeAddExperienceLevelHooks != null || overrideAddExperienceLevelHooks != null
        ...
        isAttackTargetEntityWithCurrentItemModded = beforeAttackTargetEntityWithCurrentItemHooks != null
        ...
        isCanBreatheUnderwaterModded = beforeCanBreatheUnderwaterHooks != null
        ...
        isClonePlayerModded = beforeClonePlayerHooks != null || overrideClonePlayerHooks != null
        ...
        isGetCurrentPlayerStrVsBlockModded = beforeGetCurrentPlayerStrVsBlockHooks != null
        ...
        isGetCurrentPlayerStrVsBlockForgeModded = beforeGetCurrentPlayerStrVsBlockForgeHooks != null
        ...
        isGetEyeHeightModded = beforeGetEyeHeightHooks != null || overrideGetEyeHeightHooks != null
        ...
        isIsEntityInsideOpaqueBlockModded = beforeIsEntityInsideOpaqueBlockHooks != null
        ...
        isMountEntityModded = beforeMountEntityHooks != null || overrideMountEntityHooks != null
        ...
        isMoveEntityWithHeadingModded = beforeMoveEntityWithHeadingHooks != null
        ...
        isOnUpdateEntityModded = beforeOnUpdateEntityHooks != null || overrideOnUpdateEntityHooks != null
        ...
        isSetEntityActionStateModded = beforeSetEntityActionStateHooks != null
        ...
        isSetPositionModded = beforeSetPositionHooks != null || overrideSetPositionHooks != null
        ...
        isUpdateEntityActionStateModded = beforeUpdateEntityActionStateHooks != null
        ...
        isUpdatePotionEffectsModded = beforeUpdatePotionEffectsHooks != null || overrideUpdatePotionEffectsHooks != null
    ...
    private ServerPlayerBase[] create(List<String> types) {
        ...
        for (int i = 0; i < result.length; i++) result[i] = getServerPlayerBase(types.get(i));
        return result;
    }

    private void beforeLocalConstructing(MinecraftServer paramMinecraftServer, WorldServer paramWorldServer,
    ...
    private void afterLocalConstructing(MinecraftServer paramMinecraftServer, WorldServer paramWorldServer,
            GameProfile paramGameProfile, ItemInWorldManager paramItemInWorldManager) {
    ...
    public Object dynamicOverwritten(String key, Object[] parameters, ServerPlayerBase overwriter) {
        ...
        } else methodMap = overrideDynamicHookMethods;
    ...
    public static void addExhaustion(IServerPlayerAPI target, float paramFloat) {
        ...
        if (serverPlayerAPI != null && serverPlayerAPI.isAddExhaustionModded) serverPlayerAPI.addExhaustion(paramFloat);
        else target.localAddExhaustion(paramFloat);
    }
    ...
    private static final List<String> beforeAddExhaustionHookTypes = new LinkedList<String>();
    private static final List<String> overrideAddExhaustionHookTypes = new LinkedList<String>();
    private static final List<String> afterAddExhaustionHookTypes = new LinkedList<String>();
    ...
    public static void addExperience(IServerPlayerAPI target, int paramInt) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isAddExperienceModded) serverPlayerAPI.addExperience(paramInt);
        else target.localAddExperience(paramInt);
    }

    private void addExperience(int paramInt) {
        if (beforeAddExperienceHooks != null) for (int i = beforeAddExperienceHooks.length - 1; i >= 0; i--)
        ...
        else player.localAddExperience(paramInt);

        if (afterAddExperienceHooks != null) for (int i = 0; i < afterAddExperienceHooks.length; i++)
    ...
    protected ServerPlayerBase GetOverwrittenAddExperience(ServerPlayerBase overWriter) {
        if (overrideAddExperienceHooks == null) return overWriter;

        for (int i = 0; i < overrideAddExperienceHooks.length; i++)
            if (overrideAddExperienceHooks[i] == overWriter) if (i == 0) return null;
            else return overrideAddExperienceHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeAddExperienceHookTypes = new LinkedList<String>();
    private static final List<String> overrideAddExperienceHookTypes = new LinkedList<String>();
    private static final List<String> afterAddExperienceHookTypes = new LinkedList<String>();
    ...
    private static final Map<String, String[]> allBaseOverrideAddExperienceSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideAddExperienceInferiors = new Hashtable<String, String[]>(
            0);
    ...
    public static void addExperienceLevel(IServerPlayerAPI target, int paramInt) {
        ...
        else target.localAddExperienceLevel(paramInt);
    }

    private void addExperienceLevel(int paramInt) {
        if (beforeAddExperienceLevelHooks != null) for (int i = beforeAddExperienceLevelHooks.length - 1; i >= 0; i--)
        ...
        else player.localAddExperienceLevel(paramInt);

        if (afterAddExperienceLevelHooks != null) for (int i = 0; i < afterAddExperienceLevelHooks.length; i++)
    ...
    protected ServerPlayerBase GetOverwrittenAddExperienceLevel(ServerPlayerBase overWriter) {
        if (overrideAddExperienceLevelHooks == null) return overWriter;

        for (int i = 0; i < overrideAddExperienceLevelHooks.length; i++)
            if (overrideAddExperienceLevelHooks[i] == overWriter) if (i == 0) return null;
            else return overrideAddExperienceLevelHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeAddExperienceLevelHookTypes = new LinkedList<String>();
    private static final List<String> overrideAddExperienceLevelHookTypes = new LinkedList<String>();
    private static final List<String> afterAddExperienceLevelHookTypes = new LinkedList<String>();
    ...
    private static final Map<String, String[]> allBaseBeforeAddExperienceLevelSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseBeforeAddExperienceLevelInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideAddExperienceLevelSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideAddExperienceLevelInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseAfterAddExperienceLevelSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseAfterAddExperienceLevelInferiors = new Hashtable<String, String[]>(
            0);

    public static void addMovementStat(IServerPlayerAPI target, double paramDouble1, double paramDouble2,
            double paramDouble3) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else target.localAddMovementStat(paramDouble1, paramDouble2, paramDouble3);
    }
    ...
    private static final List<String> beforeAddMovementStatHookTypes = new LinkedList<String>();
    private static final List<String> overrideAddMovementStatHookTypes = new LinkedList<String>();
    private static final List<String> afterAddMovementStatHookTypes = new LinkedList<String>();
    ...
    public static boolean attackEntityFrom(IServerPlayerAPI target, DamageSource paramDamageSource, float paramFloat) {
        boolean _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else _result = target.localAttackEntityFrom(paramDamageSource, paramFloat);
        return _result;
    }
    ...
    private static final List<String> beforeAttackEntityFromHookTypes = new LinkedList<String>();
    private static final List<String> overrideAttackEntityFromHookTypes = new LinkedList<String>();
    private static final List<String> afterAttackEntityFromHookTypes = new LinkedList<String>();
    ...
    public static void attackTargetEntityWithCurrentItem(IServerPlayerAPI target, Entity paramEntity) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private void attackTargetEntityWithCurrentItem(Entity paramEntity) {
        ...
        if (overrideAttackTargetEntityWithCurrentItemHooks != null)
            overrideAttackTargetEntityWithCurrentItemHooks[overrideAttackTargetEntityWithCurrentItemHooks.length - 1]
                    .attackTargetEntityWithCurrentItem(paramEntity);
        else player.localAttackTargetEntityWithCurrentItem(paramEntity);
    ...
    private static final List<String> beforeAttackTargetEntityWithCurrentItemHookTypes = new LinkedList<String>();
    private static final List<String> overrideAttackTargetEntityWithCurrentItemHookTypes = new LinkedList<String>();
    private static final List<String> afterAttackTargetEntityWithCurrentItemHookTypes = new LinkedList<String>();
    ...
    public static boolean canBreatheUnderwater(IServerPlayerAPI target) {
        ...
        else _result = target.localCanBreatheUnderwater();
        return _result;
    }
    ...
    private static final List<String> beforeCanBreatheUnderwaterHookTypes = new LinkedList<String>();
    private static final List<String> overrideCanBreatheUnderwaterHookTypes = new LinkedList<String>();
    private static final List<String> afterCanBreatheUnderwaterHookTypes = new LinkedList<String>();
    ...
    public static boolean canHarvestBlock(IServerPlayerAPI target, Block paramBlock) {
        boolean _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isCanHarvestBlockModded)
            _result = serverPlayerAPI.canHarvestBlock(paramBlock);
        else _result = target.localCanHarvestBlock(paramBlock);
        return _result;
    }
    ...
    private static final List<String> beforeCanHarvestBlockHookTypes = new LinkedList<String>();
    private static final List<String> overrideCanHarvestBlockHookTypes = new LinkedList<String>();
    private static final List<String> afterCanHarvestBlockHookTypes = new LinkedList<String>();
    ...
    public static boolean canPlayerEdit(IServerPlayerAPI target, int paramInt1, int paramInt2, int paramInt3,
        ...
        else _result = target.localCanPlayerEdit(paramInt1, paramInt2, paramInt3, paramInt4, paramItemStack);
        return _result;
    }
    ...
    private static final List<String> beforeCanPlayerEditHookTypes = new LinkedList<String>();
    private static final List<String> overrideCanPlayerEditHookTypes = new LinkedList<String>();
    private static final List<String> afterCanPlayerEditHookTypes = new LinkedList<String>();
    ...
    public static boolean canTriggerWalking(IServerPlayerAPI target) {
        ...
        else _result = target.localCanTriggerWalking();
        return _result;
    }
    ...
    private static final List<String> beforeCanTriggerWalkingHookTypes = new LinkedList<String>();
    private static final List<String> overrideCanTriggerWalkingHookTypes = new LinkedList<String>();
    private static final List<String> afterCanTriggerWalkingHookTypes = new LinkedList<String>();
    ...
    public static void clonePlayer(IServerPlayerAPI target, EntityPlayer paramEntityPlayer, boolean paramBoolean) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isClonePlayerModded)
            serverPlayerAPI.clonePlayer(paramEntityPlayer, paramBoolean);
        else target.localClonePlayer(paramEntityPlayer, paramBoolean);
    }

    private void clonePlayer(EntityPlayer paramEntityPlayer, boolean paramBoolean) {
        if (beforeClonePlayerHooks != null) for (int i = beforeClonePlayerHooks.length - 1; i >= 0; i--)
        ...
        else player.localClonePlayer(paramEntityPlayer, paramBoolean);

        if (afterClonePlayerHooks != null) for (int i = 0; i < afterClonePlayerHooks.length; i++)
    ...
    protected ServerPlayerBase GetOverwrittenClonePlayer(ServerPlayerBase overWriter) {
        if (overrideClonePlayerHooks == null) return overWriter;

        for (int i = 0; i < overrideClonePlayerHooks.length; i++)
            if (overrideClonePlayerHooks[i] == overWriter) if (i == 0) return null;
            else return overrideClonePlayerHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeClonePlayerHookTypes = new LinkedList<String>();
    private static final List<String> overrideClonePlayerHookTypes = new LinkedList<String>();
    private static final List<String> afterClonePlayerHookTypes = new LinkedList<String>();
    ...
    public static void damageEntity(IServerPlayerAPI target, DamageSource paramDamageSource, float paramFloat) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeDamageEntityHookTypes = new LinkedList<String>();
    private static final List<String> overrideDamageEntityHookTypes = new LinkedList<String>();
    private static final List<String> afterDamageEntityHookTypes = new LinkedList<String>();
    ...
    public static void displayGUIChest(IServerPlayerAPI target, IInventory paramIInventory) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeDisplayGUIChestHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIChestHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIChestHookTypes = new LinkedList<String>();
    ...
    public static void displayGUIDispenser(IServerPlayerAPI target, TileEntityDispenser paramTileEntityDispenser) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeDisplayGUIDispenserHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIDispenserHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIDispenserHookTypes = new LinkedList<String>();
    ...
    public static void displayGUIFurnace(IServerPlayerAPI target, TileEntityFurnace paramTileEntityFurnace) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeDisplayGUIFurnaceHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIFurnaceHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIFurnaceHookTypes = new LinkedList<String>();
    ...
    public static void displayGUIWorkbench(IServerPlayerAPI target, int paramInt1, int paramInt2, int paramInt3) {
        ...
        else target.localDisplayGUIWorkbench(paramInt1, paramInt2, paramInt3);
    }
    ...
    private static final List<String> beforeDisplayGUIWorkbenchHookTypes = new LinkedList<String>();
    private static final List<String> overrideDisplayGUIWorkbenchHookTypes = new LinkedList<String>();
    private static final List<String> afterDisplayGUIWorkbenchHookTypes = new LinkedList<String>();
    ...
    public static EntityItem dropOneItem(IServerPlayerAPI target, boolean paramBoolean) {
        EntityItem _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isDropOneItemModded)
            _result = serverPlayerAPI.dropOneItem(paramBoolean);
        else _result = target.localDropOneItem(paramBoolean);
        return _result;
    }
    ...
    private static final List<String> beforeDropOneItemHookTypes = new LinkedList<String>();
    private static final List<String> overrideDropOneItemHookTypes = new LinkedList<String>();
    private static final List<String> afterDropOneItemHookTypes = new LinkedList<String>();
    ...
    public static EntityItem dropPlayerItem(IServerPlayerAPI target, ItemStack paramItemStack, boolean paramBoolean) {
        EntityItem _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else _result = target.localDropPlayerItem(paramItemStack, paramBoolean);
        return _result;
    }
    ...
    private static final List<String> beforeDropPlayerItemHookTypes = new LinkedList<String>();
    private static final List<String> overrideDropPlayerItemHookTypes = new LinkedList<String>();
    private static final List<String> afterDropPlayerItemHookTypes = new LinkedList<String>();
    ...
    public static void fall(IServerPlayerAPI target, float paramFloat) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isFallModded) serverPlayerAPI.fall(paramFloat);
        else target.localFall(paramFloat);
    }

    private void fall(float paramFloat) {
        if (beforeFallHooks != null)
            for (int i = beforeFallHooks.length - 1; i >= 0; i--) beforeFallHooks[i].beforeFall(paramFloat);

        if (overrideFallHooks != null) overrideFallHooks[overrideFallHooks.length - 1].fall(paramFloat);
        else player.localFall(paramFloat);

        if (afterFallHooks != null)
            for (int i = 0; i < afterFallHooks.length; i++) afterFallHooks[i].afterFall(paramFloat);
    }
    ...
    private static final List<String> beforeFallHookTypes = new LinkedList<String>();
    private static final List<String> overrideFallHookTypes = new LinkedList<String>();
    private static final List<String> afterFallHookTypes = new LinkedList<String>();
    ...
    public static float getAIMoveSpeed(IServerPlayerAPI target) {
        ...
        else _result = target.localGetAIMoveSpeed();
        return _result;
    }
    ...
    private float getAIMoveSpeed() {
        ...
        else _result = player.localGetAIMoveSpeed();

        if (afterGetAIMoveSpeedHooks != null)
            for (int i = 0; i < afterGetAIMoveSpeedHooks.length; i++) afterGetAIMoveSpeedHooks[i].afterGetAIMoveSpeed();
    ...
    private static final List<String> beforeGetAIMoveSpeedHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetAIMoveSpeedHookTypes = new LinkedList<String>();
    private static final List<String> afterGetAIMoveSpeedHookTypes = new LinkedList<String>();
    ...
    public static float getCurrentPlayerStrVsBlock(IServerPlayerAPI target, Block paramBlock, boolean paramBoolean) {
        float _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else _result = target.localGetCurrentPlayerStrVsBlock(paramBlock, paramBoolean);
        return _result;
    }
    ...
    private static final List<String> beforeGetCurrentPlayerStrVsBlockHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetCurrentPlayerStrVsBlockHookTypes = new LinkedList<String>();
    private static final List<String> afterGetCurrentPlayerStrVsBlockHookTypes = new LinkedList<String>();
    ...
    public static float getCurrentPlayerStrVsBlockForge(IServerPlayerAPI target, Block paramBlock, boolean paramBoolean,
            int paramInt) {
        float _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else _result = target.localGetCurrentPlayerStrVsBlockForge(paramBlock, paramBoolean, paramInt);
        return _result;
    }
    ...
    private static final List<String> beforeGetCurrentPlayerStrVsBlockForgeHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetCurrentPlayerStrVsBlockForgeHookTypes = new LinkedList<String>();
    private static final List<String> afterGetCurrentPlayerStrVsBlockForgeHookTypes = new LinkedList<String>();
    ...
    public static double getDistanceSq(IServerPlayerAPI target, double paramDouble1, double paramDouble2,
            double paramDouble3) {
        double _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else _result = target.localGetDistanceSq(paramDouble1, paramDouble2, paramDouble3);
        return _result;
    }
    ...
    private static final List<String> beforeGetDistanceSqHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetDistanceSqHookTypes = new LinkedList<String>();
    private static final List<String> afterGetDistanceSqHookTypes = new LinkedList<String>();
    ...
    public static float getBrightness(IServerPlayerAPI target, float paramFloat) {
        ...
        else _result = target.localGetBrightness(paramFloat);
        return _result;
    }
    ...
    private static final List<String> beforeGetBrightnessHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetBrightnessHookTypes = new LinkedList<String>();
    private static final List<String> afterGetBrightnessHookTypes = new LinkedList<String>();
    ...
    public static float getEyeHeight(IServerPlayerAPI target) {
        float _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isGetEyeHeightModded) _result = serverPlayerAPI.getEyeHeight();
        else _result = target.localGetEyeHeight();
        return _result;
    }

    private float getEyeHeight() {
        if (beforeGetEyeHeightHooks != null) for (int i = beforeGetEyeHeightHooks.length - 1; i >= 0; i--)
        ...
        else _result = player.localGetEyeHeight();

        if (afterGetEyeHeightHooks != null)
            for (int i = 0; i < afterGetEyeHeightHooks.length; i++) afterGetEyeHeightHooks[i].afterGetEyeHeight();

        return _result;
    }

    protected ServerPlayerBase GetOverwrittenGetEyeHeight(ServerPlayerBase overWriter) {
        if (overrideGetEyeHeightHooks == null) return overWriter;

        for (int i = 0; i < overrideGetEyeHeightHooks.length; i++)
            if (overrideGetEyeHeightHooks[i] == overWriter) if (i == 0) return null;
            else return overrideGetEyeHeightHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeGetEyeHeightHookTypes = new LinkedList<String>();
    private static final List<String> overrideGetEyeHeightHookTypes = new LinkedList<String>();
    private static final List<String> afterGetEyeHeightHookTypes = new LinkedList<String>();
    ...
    private static final Map<String, String[]> allBaseOverrideGetEyeHeightSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideGetEyeHeightInferiors = new Hashtable<String, String[]>(
            0);
    ...
    public static void heal(IServerPlayerAPI target, float paramFloat) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isHealModded) serverPlayerAPI.heal(paramFloat);
        else target.localHeal(paramFloat);
    }

    private void heal(float paramFloat) {
        if (beforeHealHooks != null)
            for (int i = beforeHealHooks.length - 1; i >= 0; i--) beforeHealHooks[i].beforeHeal(paramFloat);

        if (overrideHealHooks != null) overrideHealHooks[overrideHealHooks.length - 1].heal(paramFloat);
        else player.localHeal(paramFloat);

        if (afterHealHooks != null)
            for (int i = 0; i < afterHealHooks.length; i++) afterHealHooks[i].afterHeal(paramFloat);
    }
    ...
    private static final List<String> beforeHealHookTypes = new LinkedList<String>();
    private static final List<String> overrideHealHookTypes = new LinkedList<String>();
    private static final List<String> afterHealHookTypes = new LinkedList<String>();
    ...
    private static final List<String> beforeIsEntityInsideOpaqueBlockHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsEntityInsideOpaqueBlockHookTypes = new LinkedList<String>();
    private static final List<String> afterIsEntityInsideOpaqueBlockHookTypes = new LinkedList<String>();
    ...
    public static boolean isInWater(IServerPlayerAPI target) {
        boolean _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isIsInWaterModded) _result = serverPlayerAPI.isInWater();
        else _result = target.localIsInWater();
        return _result;
    }

    private boolean isInWater() {
        if (beforeIsInWaterHooks != null)
            for (int i = beforeIsInWaterHooks.length - 1; i >= 0; i--) beforeIsInWaterHooks[i].beforeIsInWater();

        boolean _result;
        if (overrideIsInWaterHooks != null)
            _result = overrideIsInWaterHooks[overrideIsInWaterHooks.length - 1].isInWater();
        else _result = player.localIsInWater();

        if (afterIsInWaterHooks != null)
            for (int i = 0; i < afterIsInWaterHooks.length; i++) afterIsInWaterHooks[i].afterIsInWater();
    ...
    private static final List<String> beforeIsInWaterHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsInWaterHookTypes = new LinkedList<String>();
    private static final List<String> afterIsInWaterHookTypes = new LinkedList<String>();
    ...
    public static boolean isInsideOfMaterial(IServerPlayerAPI target, Material paramMaterial) {
        boolean _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else _result = target.localIsInsideOfMaterial(paramMaterial);
        return _result;
    }
    ...
    private static final List<String> beforeIsInsideOfMaterialHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsInsideOfMaterialHookTypes = new LinkedList<String>();
    private static final List<String> afterIsInsideOfMaterialHookTypes = new LinkedList<String>();
    ...
    public static boolean isOnLadder(IServerPlayerAPI target) {
        boolean _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isIsOnLadderModded) _result = serverPlayerAPI.isOnLadder();
        else _result = target.localIsOnLadder();
        return _result;
    }

    private boolean isOnLadder() {
        if (beforeIsOnLadderHooks != null)
            for (int i = beforeIsOnLadderHooks.length - 1; i >= 0; i--) beforeIsOnLadderHooks[i].beforeIsOnLadder();

        boolean _result;
        if (overrideIsOnLadderHooks != null)
            _result = overrideIsOnLadderHooks[overrideIsOnLadderHooks.length - 1].isOnLadder();
        else _result = player.localIsOnLadder();

        if (afterIsOnLadderHooks != null)
            for (int i = 0; i < afterIsOnLadderHooks.length; i++) afterIsOnLadderHooks[i].afterIsOnLadder();
    ...
    private static final List<String> beforeIsOnLadderHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsOnLadderHookTypes = new LinkedList<String>();
    private static final List<String> afterIsOnLadderHookTypes = new LinkedList<String>();
    ...
    public static boolean isPlayerSleeping(IServerPlayerAPI target) {
        ...
        else _result = target.localIsPlayerSleeping();
        return _result;
    }
    ...
    private static final List<String> beforeIsPlayerSleepingHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsPlayerSleepingHookTypes = new LinkedList<String>();
    private static final List<String> afterIsPlayerSleepingHookTypes = new LinkedList<String>();
    ...
    public static boolean isSneaking(IServerPlayerAPI target) {
        boolean _result;
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isIsSneakingModded) _result = serverPlayerAPI.isSneaking();
        else _result = target.localIsSneaking();
        return _result;
    }

    private boolean isSneaking() {
        if (beforeIsSneakingHooks != null)
            for (int i = beforeIsSneakingHooks.length - 1; i >= 0; i--) beforeIsSneakingHooks[i].beforeIsSneaking();

        boolean _result;
        if (overrideIsSneakingHooks != null)
            _result = overrideIsSneakingHooks[overrideIsSneakingHooks.length - 1].isSneaking();
        else _result = player.localIsSneaking();

        if (afterIsSneakingHooks != null)
            for (int i = 0; i < afterIsSneakingHooks.length; i++) afterIsSneakingHooks[i].afterIsSneaking();
    ...
    private static final List<String> beforeIsSneakingHookTypes = new LinkedList<String>();
    private static final List<String> overrideIsSneakingHookTypes = new LinkedList<String>();
    private static final List<String> afterIsSneakingHookTypes = new LinkedList<String>();
    ...
    public static void jump(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isJumpModded) serverPlayerAPI.jump();
        else target.localJump();
    }

    private void jump() {
        if (beforeJumpHooks != null)
            for (int i = beforeJumpHooks.length - 1; i >= 0; i--) beforeJumpHooks[i].beforeJump();

        if (overrideJumpHooks != null) overrideJumpHooks[overrideJumpHooks.length - 1].jump();
        else player.localJump();

        if (afterJumpHooks != null) for (int i = 0; i < afterJumpHooks.length; i++) afterJumpHooks[i].afterJump();
    }
    ...
    private static final List<String> beforeJumpHookTypes = new LinkedList<String>();
    private static final List<String> overrideJumpHookTypes = new LinkedList<String>();
    private static final List<String> afterJumpHookTypes = new LinkedList<String>();
    ...
    public static void knockBack(IServerPlayerAPI target, Entity paramEntity, float paramFloat, double paramDouble1,
            double paramDouble2) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeKnockBackHookTypes = new LinkedList<String>();
    private static final List<String> overrideKnockBackHookTypes = new LinkedList<String>();
    private static final List<String> afterKnockBackHookTypes = new LinkedList<String>();
    ...
    public static void mountEntity(IServerPlayerAPI target, Entity paramEntity) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isMountEntityModded) serverPlayerAPI.mountEntity(paramEntity);
        else target.localMountEntity(paramEntity);
    }

    private void mountEntity(Entity paramEntity) {
        if (beforeMountEntityHooks != null) for (int i = beforeMountEntityHooks.length - 1; i >= 0; i--)
        ...
        else player.localMountEntity(paramEntity);

        if (afterMountEntityHooks != null) for (int i = 0; i < afterMountEntityHooks.length; i++)
    ...
    protected ServerPlayerBase GetOverwrittenMountEntity(ServerPlayerBase overWriter) {
        if (overrideMountEntityHooks == null) return overWriter;

        for (int i = 0; i < overrideMountEntityHooks.length; i++)
            if (overrideMountEntityHooks[i] == overWriter) if (i == 0) return null;
            else return overrideMountEntityHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeMountEntityHookTypes = new LinkedList<String>();
    private static final List<String> overrideMountEntityHookTypes = new LinkedList<String>();
    private static final List<String> afterMountEntityHookTypes = new LinkedList<String>();
    ...
    public static void moveEntity(IServerPlayerAPI target, double paramDouble1, double paramDouble2,
            double paramDouble3) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else target.localMoveEntity(paramDouble1, paramDouble2, paramDouble3);
    }
    ...
    private static final List<String> beforeMoveEntityHookTypes = new LinkedList<String>();
    private static final List<String> overrideMoveEntityHookTypes = new LinkedList<String>();
    private static final List<String> afterMoveEntityHookTypes = new LinkedList<String>();
    ...
    public static void moveEntityWithHeading(IServerPlayerAPI target, float paramFloat1, float paramFloat2) {
        ...
        else target.localMoveEntityWithHeading(paramFloat1, paramFloat2);
    }
    ...
    private static final List<String> beforeMoveEntityWithHeadingHookTypes = new LinkedList<String>();
    private static final List<String> overrideMoveEntityWithHeadingHookTypes = new LinkedList<String>();
    private static final List<String> afterMoveEntityWithHeadingHookTypes = new LinkedList<String>();
    ...
    public static void moveFlying(IServerPlayerAPI target, float paramFloat1, float paramFloat2, float paramFloat3) {
        ...
        else target.localMoveFlying(paramFloat1, paramFloat2, paramFloat3);
    }
    ...
    private static final List<String> beforeMoveFlyingHookTypes = new LinkedList<String>();
    private static final List<String> overrideMoveFlyingHookTypes = new LinkedList<String>();
    private static final List<String> afterMoveFlyingHookTypes = new LinkedList<String>();
    ...
    public static void onDeath(IServerPlayerAPI target, DamageSource paramDamageSource) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isOnDeathModded) serverPlayerAPI.onDeath(paramDamageSource);
    ...
    private void onDeath(DamageSource paramDamageSource) {
        ...
        else player.localOnDeath(paramDamageSource);

        if (afterOnDeathHooks != null)
            for (int i = 0; i < afterOnDeathHooks.length; i++) afterOnDeathHooks[i].afterOnDeath(paramDamageSource);
    }
    ...
    private static final List<String> beforeOnDeathHookTypes = new LinkedList<String>();
    private static final List<String> overrideOnDeathHookTypes = new LinkedList<String>();
    private static final List<String> afterOnDeathHookTypes = new LinkedList<String>();
    ...
    public static void onLivingUpdate(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isOnLivingUpdateModded) serverPlayerAPI.onLivingUpdate();
        else target.localOnLivingUpdate();
    }
    ...
    private void onLivingUpdate() {
        ...
        else player.localOnLivingUpdate();

        if (afterOnLivingUpdateHooks != null)
            for (int i = 0; i < afterOnLivingUpdateHooks.length; i++) afterOnLivingUpdateHooks[i].afterOnLivingUpdate();
    }
    ...
    private static final List<String> beforeOnLivingUpdateHookTypes = new LinkedList<String>();
    private static final List<String> overrideOnLivingUpdateHookTypes = new LinkedList<String>();
    private static final List<String> afterOnLivingUpdateHookTypes = new LinkedList<String>();
    ...
    public static void onKillEntity(IServerPlayerAPI target, EntityLivingBase paramEntityLivingBase) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeOnKillEntityHookTypes = new LinkedList<String>();
    private static final List<String> overrideOnKillEntityHookTypes = new LinkedList<String>();
    private static final List<String> afterOnKillEntityHookTypes = new LinkedList<String>();
    ...
    public static void onStruckByLightning(IServerPlayerAPI target, EntityLightningBolt paramEntityLightningBolt) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeOnStruckByLightningHookTypes = new LinkedList<String>();
    private static final List<String> overrideOnStruckByLightningHookTypes = new LinkedList<String>();
    private static final List<String> afterOnStruckByLightningHookTypes = new LinkedList<String>();
    ...
    public static void onUpdate(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isOnUpdateModded) serverPlayerAPI.onUpdate();
        else target.localOnUpdate();
    }

    private void onUpdate() {
        if (beforeOnUpdateHooks != null)
            for (int i = beforeOnUpdateHooks.length - 1; i >= 0; i--) beforeOnUpdateHooks[i].beforeOnUpdate();

        if (overrideOnUpdateHooks != null) overrideOnUpdateHooks[overrideOnUpdateHooks.length - 1].onUpdate();
        else player.localOnUpdate();

        if (afterOnUpdateHooks != null)
            for (int i = 0; i < afterOnUpdateHooks.length; i++) afterOnUpdateHooks[i].afterOnUpdate();
    }
    ...
    private static final List<String> beforeOnUpdateHookTypes = new LinkedList<String>();
    private static final List<String> overrideOnUpdateHookTypes = new LinkedList<String>();
    private static final List<String> afterOnUpdateHookTypes = new LinkedList<String>();
    ...
    public static void onUpdateEntity(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isOnUpdateEntityModded) serverPlayerAPI.onUpdateEntity();
        else target.localOnUpdateEntity();
    }

    private void onUpdateEntity() {
        if (beforeOnUpdateEntityHooks != null) for (int i = beforeOnUpdateEntityHooks.length - 1; i >= 0; i--)
        ...
        else player.localOnUpdateEntity();

        if (afterOnUpdateEntityHooks != null)
            for (int i = 0; i < afterOnUpdateEntityHooks.length; i++) afterOnUpdateEntityHooks[i].afterOnUpdateEntity();
    }

    protected ServerPlayerBase GetOverwrittenOnUpdateEntity(ServerPlayerBase overWriter) {
        if (overrideOnUpdateEntityHooks == null) return overWriter;

        for (int i = 0; i < overrideOnUpdateEntityHooks.length; i++)
            if (overrideOnUpdateEntityHooks[i] == overWriter) if (i == 0) return null;
            else return overrideOnUpdateEntityHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeOnUpdateEntityHookTypes = new LinkedList<String>();
    private static final List<String> overrideOnUpdateEntityHookTypes = new LinkedList<String>();
    private static final List<String> afterOnUpdateEntityHookTypes = new LinkedList<String>();
    ...
    private static final Map<String, String[]> allBaseBeforeOnUpdateEntitySuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseBeforeOnUpdateEntityInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideOnUpdateEntitySuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideOnUpdateEntityInferiors = new Hashtable<String, String[]>(
            0);
    ...
    public static void readEntityFromNBT(IServerPlayerAPI target, NBTTagCompound paramNBTTagCompound) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeReadEntityFromNBTHookTypes = new LinkedList<String>();
    private static final List<String> overrideReadEntityFromNBTHookTypes = new LinkedList<String>();
    private static final List<String> afterReadEntityFromNBTHookTypes = new LinkedList<String>();
    ...
    public static void setDead(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isSetDeadModded) serverPlayerAPI.setDead();
        else target.localSetDead();
    }

    private void setDead() {
        if (beforeSetDeadHooks != null)
            for (int i = beforeSetDeadHooks.length - 1; i >= 0; i--) beforeSetDeadHooks[i].beforeSetDead();

        if (overrideSetDeadHooks != null) overrideSetDeadHooks[overrideSetDeadHooks.length - 1].setDead();
        else player.localSetDead();

        if (afterSetDeadHooks != null)
            for (int i = 0; i < afterSetDeadHooks.length; i++) afterSetDeadHooks[i].afterSetDead();
    }
    ...
    private static final List<String> beforeSetDeadHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetDeadHookTypes = new LinkedList<String>();
    private static final List<String> afterSetDeadHookTypes = new LinkedList<String>();
    ...
    public static void setEntityActionState(IServerPlayerAPI target, float paramFloat1, float paramFloat2,
        ...
        else target.localSetEntityActionState(paramFloat1, paramFloat2, paramBoolean1, paramBoolean2);
    }

    private void setEntityActionState(float paramFloat1, float paramFloat2, boolean paramBoolean1,
            boolean paramBoolean2) {
        if (beforeSetEntityActionStateHooks != null)
            for (int i = beforeSetEntityActionStateHooks.length - 1; i >= 0; i--) beforeSetEntityActionStateHooks[i]
                    .beforeSetEntityActionState(paramFloat1, paramFloat2, paramBoolean1, paramBoolean2);

        if (overrideSetEntityActionStateHooks != null)
            overrideSetEntityActionStateHooks[overrideSetEntityActionStateHooks.length - 1]
                    .setEntityActionState(paramFloat1, paramFloat2, paramBoolean1, paramBoolean2);
        else player.localSetEntityActionState(paramFloat1, paramFloat2, paramBoolean1, paramBoolean2);

        if (afterSetEntityActionStateHooks != null)
            for (int i = 0; i < afterSetEntityActionStateHooks.length; i++) afterSetEntityActionStateHooks[i]
                    .afterSetEntityActionState(paramFloat1, paramFloat2, paramBoolean1, paramBoolean2);
    }

    protected ServerPlayerBase GetOverwrittenSetEntityActionState(ServerPlayerBase overWriter) {
        if (overrideSetEntityActionStateHooks == null) return overWriter;

        for (int i = 0; i < overrideSetEntityActionStateHooks.length; i++)
            if (overrideSetEntityActionStateHooks[i] == overWriter) if (i == 0) return null;
            else return overrideSetEntityActionStateHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeSetEntityActionStateHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetEntityActionStateHookTypes = new LinkedList<String>();
    private static final List<String> afterSetEntityActionStateHookTypes = new LinkedList<String>();
    ...
    private static final Map<String, String[]> allBaseBeforeSetEntityActionStateSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseBeforeSetEntityActionStateInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideSetEntityActionStateSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideSetEntityActionStateInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseAfterSetEntityActionStateSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseAfterSetEntityActionStateInferiors = new Hashtable<String, String[]>(
            0);

    public static void setPosition(IServerPlayerAPI target, double paramDouble1, double paramDouble2,
            double paramDouble3) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        ...
        else target.localSetPosition(paramDouble1, paramDouble2, paramDouble3);
    }

    private void setPosition(double paramDouble1, double paramDouble2, double paramDouble3) {
        if (beforeSetPositionHooks != null) for (int i = beforeSetPositionHooks.length - 1; i >= 0; i--)
            beforeSetPositionHooks[i].beforeSetPosition(paramDouble1, paramDouble2, paramDouble3);

        if (overrideSetPositionHooks != null) overrideSetPositionHooks[overrideSetPositionHooks.length - 1]
                .setPosition(paramDouble1, paramDouble2, paramDouble3);
        else player.localSetPosition(paramDouble1, paramDouble2, paramDouble3);

        if (afterSetPositionHooks != null) for (int i = 0; i < afterSetPositionHooks.length; i++)
    ...
    protected ServerPlayerBase GetOverwrittenSetPosition(ServerPlayerBase overWriter) {
        if (overrideSetPositionHooks == null) return overWriter;

        for (int i = 0; i < overrideSetPositionHooks.length; i++)
            if (overrideSetPositionHooks[i] == overWriter) if (i == 0) return null;
            else return overrideSetPositionHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeSetPositionHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetPositionHookTypes = new LinkedList<String>();
    private static final List<String> afterSetPositionHookTypes = new LinkedList<String>();
    ...
    public static void setSneaking(IServerPlayerAPI target, boolean paramBoolean) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isSetSneakingModded) serverPlayerAPI.setSneaking(paramBoolean);
        else target.localSetSneaking(paramBoolean);
    }
    ...
    private static final List<String> beforeSetSneakingHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetSneakingHookTypes = new LinkedList<String>();
    private static final List<String> afterSetSneakingHookTypes = new LinkedList<String>();
    ...
    public static void setSprinting(IServerPlayerAPI target, boolean paramBoolean) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isSetSprintingModded) serverPlayerAPI.setSprinting(paramBoolean);
        else target.localSetSprinting(paramBoolean);
    }
    ...
    private static final List<String> beforeSetSprintingHookTypes = new LinkedList<String>();
    private static final List<String> overrideSetSprintingHookTypes = new LinkedList<String>();
    private static final List<String> afterSetSprintingHookTypes = new LinkedList<String>();
    ...
    public static void swingItem(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isSwingItemModded) serverPlayerAPI.swingItem();
        else target.localSwingItem();
    }

    private void swingItem() {
        if (beforeSwingItemHooks != null)
            for (int i = beforeSwingItemHooks.length - 1; i >= 0; i--) beforeSwingItemHooks[i].beforeSwingItem();

        if (overrideSwingItemHooks != null) overrideSwingItemHooks[overrideSwingItemHooks.length - 1].swingItem();
        else player.localSwingItem();

        if (afterSwingItemHooks != null)
            for (int i = 0; i < afterSwingItemHooks.length; i++) afterSwingItemHooks[i].afterSwingItem();
    }
    ...
    private static final List<String> beforeSwingItemHookTypes = new LinkedList<String>();
    private static final List<String> overrideSwingItemHookTypes = new LinkedList<String>();
    private static final List<String> afterSwingItemHookTypes = new LinkedList<String>();
    ...
    private void updateEntityActionState() {
        ...
        if (overrideUpdateEntityActionStateHooks != null)
            overrideUpdateEntityActionStateHooks[overrideUpdateEntityActionStateHooks.length - 1]
                    .updateEntityActionState();
        else player.localUpdateEntityActionState();
    ...
    private static final List<String> beforeUpdateEntityActionStateHookTypes = new LinkedList<String>();
    private static final List<String> overrideUpdateEntityActionStateHookTypes = new LinkedList<String>();
    private static final List<String> afterUpdateEntityActionStateHookTypes = new LinkedList<String>();
    ...
    public static void updatePotionEffects(IServerPlayerAPI target) {
        ...
        else target.localUpdatePotionEffects();
    }

    private void updatePotionEffects() {
        if (beforeUpdatePotionEffectsHooks != null) for (int i = beforeUpdatePotionEffectsHooks.length - 1; i >= 0; i--)
        ...
        else player.localUpdatePotionEffects();

        if (afterUpdatePotionEffectsHooks != null) for (int i = 0; i < afterUpdatePotionEffectsHooks.length; i++)
    ...
    protected ServerPlayerBase GetOverwrittenUpdatePotionEffects(ServerPlayerBase overWriter) {
        if (overrideUpdatePotionEffectsHooks == null) return overWriter;

        for (int i = 0; i < overrideUpdatePotionEffectsHooks.length; i++)
            if (overrideUpdatePotionEffectsHooks[i] == overWriter) if (i == 0) return null;
            else return overrideUpdatePotionEffectsHooks[i - 1];

        return overWriter;
    }

    private static final List<String> beforeUpdatePotionEffectsHookTypes = new LinkedList<String>();
    private static final List<String> overrideUpdatePotionEffectsHookTypes = new LinkedList<String>();
    private static final List<String> afterUpdatePotionEffectsHookTypes = new LinkedList<String>();
    ...
    private static final Map<String, String[]> allBaseBeforeUpdatePotionEffectsSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseBeforeUpdatePotionEffectsInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideUpdatePotionEffectsSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseOverrideUpdatePotionEffectsInferiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseAfterUpdatePotionEffectsSuperiors = new Hashtable<String, String[]>(
            0);
    private static final Map<String, String[]> allBaseAfterUpdatePotionEffectsInferiors = new Hashtable<String, String[]>(
            0);

    public static void updateRidden(IServerPlayerAPI target) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
        if (serverPlayerAPI != null && serverPlayerAPI.isUpdateRiddenModded) serverPlayerAPI.updateRidden();
        else target.localUpdateRidden();
    }
    ...
    private void updateRidden() {
        ...
        else player.localUpdateRidden();

        if (afterUpdateRiddenHooks != null)
            for (int i = 0; i < afterUpdateRiddenHooks.length; i++) afterUpdateRiddenHooks[i].afterUpdateRidden();
    }
    ...
    private static final List<String> beforeUpdateRiddenHookTypes = new LinkedList<String>();
    private static final List<String> overrideUpdateRiddenHookTypes = new LinkedList<String>();
    private static final List<String> afterUpdateRiddenHookTypes = new LinkedList<String>();
    ...
    public static void wakeUpPlayer(IServerPlayerAPI target, boolean paramBoolean1, boolean paramBoolean2,
        ...
        else target.localWakeUpPlayer(paramBoolean1, paramBoolean2, paramBoolean3);
    }
    ...
    private static final List<String> beforeWakeUpPlayerHookTypes = new LinkedList<String>();
    private static final List<String> overrideWakeUpPlayerHookTypes = new LinkedList<String>();
    private static final List<String> afterWakeUpPlayerHookTypes = new LinkedList<String>();
    ...
    public static void writeEntityToNBT(IServerPlayerAPI target, NBTTagCompound paramNBTTagCompound) {
        ServerPlayerAPI serverPlayerAPI = target.getServerPlayerAPI();
    ...
    private static final List<String> beforeWriteEntityToNBTHookTypes = new LinkedList<String>();
    private static final List<String> overrideWriteEntityToNBTHookTypes = new LinkedList<String>();
    private static final List<String> afterWriteEntityToNBTHookTypes = new LinkedList<String>();
